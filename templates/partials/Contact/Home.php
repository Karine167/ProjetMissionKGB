                    ...
                    <?php foreach ($allElements as $element) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/index.php?controller=back&action=Person&todo=delete&id=<?php echo($element['id_contact']) ?>" class="btn btn-primary pt-2" aria-current="pageEdit">Supprimer</a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
